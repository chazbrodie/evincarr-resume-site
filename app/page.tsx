  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-700 via-slate-600 to-slate-700 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 md:px-8 py-6 md:py-8 relative z-10">
        ...
        {/* Quick Chat CTA */}
        {!chatOpen && (
          <div className="bg-gradient-to-r from-cyan-600 to-cyan-500 rounded-2xl shadow-2xl p-6 md:p-8 mb-6 md:mb-8 text-white border border-cyan-500/30 relative overflow-hidden">
...
>
  Ask Away
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8 mb-6 md:mb-8">
          {/* Automation Projects */}
          <div className="bg-gradient-to-r from-cyan-600 to-cyan-500 rounded-2xl shadow-2xl p-6 md:p-8 text-white border border-cyan-700/30 relative overflow-hidden">
