  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-50 to-gray-100">
      <div className="max-w-5xl mx-auto p-8">
        ...
        {/* Header */}
        <header className="bg-white rounded-xl shadow-lg p-10 mb-8 border-l-4 border-[#254117]">
          <h1 className="text-5xl font-bold text-gray-900 mb-2">
            {resumeData.name}
          </h1>
          <p className="text-2xl text-[#254117] mb-4 font-medium">
            {resumeData.title}
          </p>
          <div className="flex flex-wrap gap-4 text-gray-600 text-sm">
            ...
            <a href={`https://${resumeData.linkedin}`} target="_blank" className="text-[#254117] hover:text-[#1a2d10] font-medium">
              LinkedIn →
            </a>
          </div>
        </header>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          {/* Automations */}
          <section className="bg-[#254117] rounded-xl shadow-lg p-8 text-white">
          ...
          {/* Achievements */}
          <section className="bg-white border-2 border-[#254117] rounded-xl shadow-lg p-8">
            ...
            <ul className="space-y-3">
              {resumeData.highlights?.achievements?.map((item, i) => (
                <li key={i} className="flex items-start text-sm text-gray-700 leading-relaxed">
                  <span className="mr-2 mt-0.5 text-[#254117]">•</span>
                  <span>{item}</span>
                </li>
              ))}
            </ul>
        ...
        <section className="bg-white rounded-xl shadow-lg p-8 mb-8">
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              ...
              className="text-[#254117] hover:text-[#1a2d10] font-medium"
            >
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 p-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#254117]"
                  disabled={isLoading}
                />
                <button
                  onClick={sendMessage}
                  disabled={isLoading || !input.trim()}
                  className="bg-[#254117] text-white px-8 py-4 rounded-lg hover:bg-[#1a2d10] disabled:bg-gray-400 disabled:cursor-not-allowed font-semibold"
                >
                  Send
                </button>
              </div>
          ...
          <div className="space-y-8">
            {resumeData.experience?.map((job, index) => (
              <div key={index} className="border-l-2 border-gray-300 pl-6 py-1">
                ...
                <p className="text-lg text-[#254117] font-semibold mb-1">
                  {job.company}
                </p>
                ...
                <ul className="space-y-2">
                  {job.achievements?.map((achievement, i) => (
                    <li key={i} className="flex items-start text-sm text-gray-700">
                      <span className="text-[#254117] mr-2 mt-1">→</span>
        ...
        {resumeData.education && (
          <section className="bg-white rounded-xl shadow-lg p-8 mb-8">
            ...
            <div className="border-l-2 border-gray-300 pl-6">
              ...
              <p className="text-lg text-[#254117] font-semibold">
        ...
        <section className="bg-white rounded-xl shadow-lg p-8 mb-8">
          ...
          <div className="flex flex-wrap gap-2">
            {resumeData.skills?.map((skill, index) => (
              <span
                key={index}
                className="bg-gray-100 text-gray-800 px-4 py-2 rounded-md text-sm font-medium border border-gray-300 hover:border-[#254117] hover:bg-[#254117]/5 transition-all"
              >
                {skill}
              </span>
            ))}
